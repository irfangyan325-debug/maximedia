  ...
  return (
    <>
      <style>{`
        ...
        .bh-btn:hover { transform: translateY(-2px); box-shadow: 0 7px 0 #0c1a4e; }
      `}</style>
      ...
      <section className="bh-section">
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 'clamp(0.9rem,1.6vw,1.05rem)', color: 'rgba(255,255,255,0.75)', lineHeight: 1.78, maxWidth: '520px', margin: '0 auto' }}>
            Stay ahead of the curve with the latest strategies, trends, and insights from the MAXIMEDIA team.
          </p>
          <Link href="/contact" className="bh-btn">
