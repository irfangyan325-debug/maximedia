  ...
  return (
    <>
      <style>{`
        ...
        .cph-title-black { font-size:clamp(2.2rem,6.5vw,4.8rem); line-height:1.0; color:var(--yellow); letter-spacing:-0.02em; display:block; margin-bottom:4px; }
        ...
        .cph-desc { font-size:clamp(1.2rem,1.6vw,1.05rem); color:#ffffff; line-height:1.82; max-width:660px; margin:0 auto clamp(28px,4vw,40px); }
